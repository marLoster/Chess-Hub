...
from keras.layers import Dense, Flatten, Reshape, Conv2D, MaxPool2D
...
def main():
    ...
    for i,layer_set in enumerate([
                                ...
                                (Conv2D(64, kernel_size=(4, 4), activation='sigmoid', input_shape=(12, 8, 8), data_format="channels_first"),
